            ...
            <ul>
                ...
                <li>
                    <a href="#copy-user" data-toggle="modal" data-target="#copy-user"><i
                                class="fa fa-clone" aria-hidden="true"></i> Copy User-group</a>
                </li>
                <li>
                    ...
                    <div class="row">
                        <div class="my-input-with-help col-6">
                            <div class="form-group my-input">
                                <input type="text" class="form-control" id="new-user-group"
                                       name="user_group" aria-describedby="user_group" required>
                        ...
                        <div class="my-input-with-help col-6">
                            <div class="form-group my-input">
                                ...
                                <input type="text" class="form-control" id="group_name"
                                       name="group_name" aria-describedby="group_name" required>
