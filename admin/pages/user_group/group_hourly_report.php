                                ...
                                <div class="row">
                                    <div class="my-dropdown-with-help col-12 col-md-6 col-lg-4">
                                        <div class="my-dropdown">
                                            ...
                                            <label for="group" style="font-size: 100%; transform: translate3d(0px, -40%, 0px); opacity: 0.5; background-color: transparent; padding: 15px 0px 0px 13px; z-index: 0;">group</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="my-input-with-help col-12 col-md-6 col-lg-3 ">
                                        <div class="form-group my-input">
                                            ...
                                            <input type="text" class="form-control" id="date_with_hour"
                                                name="date_with_hour" aria-describedby="date_with_hour" required>
