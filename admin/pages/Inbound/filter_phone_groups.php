                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#copy-user" data-toggle="modal" data-target="#copy-user"><i
                                            class="fa fa-clone" aria-hidden="true"></i> Add-Delete FPG Number</a>
                                </li>
                                <li>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">ADD OR DELETE NUMBERS FROM THE FILTER PHONE GROUP LIST</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="my-input-with-help col-10">
                                            <div class="form-group my-input">
                                                ...
                                                <textarea name="phone_numbers" class="form-control" id="exampleFormControlTextarea1" rows="10" cols="100"></textarea>
                                            </div>
                                            <span class="error-msg">Error Msg</span>
                                        </div>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="my-input-with-help col-6">
                                            <div class="form-group my-input">
                                                <input type="text" class="form-control" id="filter_phone_group_id" name="filter_phone_group_id"
                                                    aria-describedby="filter_phone_group_id">
                                        ...
                                        <div class="my-input-with-help col-6">
                                            <div class="form-group my-input">
                                                ...
                                                <input type="text" class="form-control" id="filter_phone_group_name" name="filter_phone_group_name"
                                                    aria-describedby="filter_phone_group_name">
                                        ...
                                        <div class="my-input-with-help col-6">
                                            <div class="form-group my-input">
                                                ...
                                                <input type="text" class="form-control" id="filter_phone_group_description" name="filter_phone_group_description"
