...
<div>
                    <div class="show-users-group">
                        ...
                        <div class="my-nav">
                            <ul>
                                <li>
                                    <a class="nav-active" href="#add-user-group" data-toggle="modal"
                                        data-target="#add-user-group"><i class="fa fa-plus-circle"
                                            aria-hidden="true"></i>
                                        Add New Call Menu</a>
                                </li>
                                <li>
                                    <a href="#copy-user" data-toggle="modal" data-target="#copy-user"><i
                                            class="fa fa-clone" aria-hidden="true"></i> Copy Call Menu</a>
                                </li>
                                <li>
                        ...
                        <div class="table-responsive my-table">
                            ...
                            <table class="all-user-table table table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col"><a href="#">MENU ID</a></th>
                                        <th scope="col"><a href="#">NAME</a></th>
                                        <th scope="col"><a href="#">GROUP </a></th>
                                        <th scope="col"><a href="#">PROMPT</a></th>
                                        <th scope="col"><a href="#">TIMEOUT</a></th>
                                        <th scope="col"><a href="#">OPTIONS</a></th>
                                        <th scope="col"><a href="#">MODIFY</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><a href="#">2FA_say_auth_code</a></td>
                                        <td> 2FA_say_auth_code</td>
                                        <td> ---ALL---</td>
                                        <td> sip-silence|hello|your|access-code|is|cm_speak_var.agi,say_digits---access_code---DP
                                        </td>
                                        <td> 1</td>
                                        <td> 1</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="my-dropdown-with-help col-12 col-md-6 ">
                                            <div class="my-dropdown">
                                                <select name="source_menu" id="source_menu">
                                                    <option value="2FA_say_auth_code">2FA_say_auth_code -
                                                        2FA_say_auth_code</option>
                                                    <option value="default---agent">default---agent - agent phones
                                                        restricted to only internal extensions</option>
                                                    <option value="defaultlog">defaultlog - logging of all outbound
                                                        calls from agent phones</option>
                                                    <option value="ind-Welcome">ind-Welcome - ind-Welcome</option>
                                                </select>
                                                <i class="fa fa-caret-down my-dropdown-arrow" aria-hidden="true"></i>
                                                <label for="source_menu">Source Group ID</label>
                                            </div>
                                            <span class="error-msg">Error Msg</span>
                                        </div>
                ...
                <div class="modal fade" id="add-user-group" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
