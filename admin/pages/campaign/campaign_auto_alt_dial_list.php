...
?><div>
    <div class="show-users">
        ...
        <div class="table-responsive my-table">
            <div class="table-top">
                <h4>Campaign Lead Auto-Alt Dial Listing</h4>
            ...
            <table class="all-user-table table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><a href="#">AUTO-ALT DIAL</a></th>
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    echo '<td><a href="?c=campaign&v=campaign_auto_modify1&id=' . $row['campaign_id'] . '">MODIFY</a></td>';
